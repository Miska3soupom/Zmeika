...
namespace Snake
{
    internal class Program
    {
        ...
        static void StartGame()
        {
            ...
            Direct currentMovement = Direct.Right;
            ...
            {
                sw.Restart();
                Direct oldMovement = currentMovement;
        ...
        static Direct ReadMovement(Direct currentDirection)
        {
            ...
            {
                ConsoleKey.UpArrow when currentDirection != Direct.Down => Direct.Up,
                ConsoleKey.DownArrow when currentDirection != Direct.Up => Direct.Down,
                ConsoleKey.LeftArrow when currentDirection != Direct.Right => Direct.Left,
                ConsoleKey.RightArrow when currentDirection != Direct.Left => Direct.Right,
                _ => currentDirection
            };
